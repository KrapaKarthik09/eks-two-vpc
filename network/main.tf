...
resource "aws_iam_instance_profile" "ec2_eks_terraform_profile" {
  name = "ec2_eks_terraform_profile"
...
module "ec2_instance" {
  ...
  iam_instance_profile = aws_iam_instance_profile.ec2_eks_terraform_profile.name
  user_data = <<EOF
    #!/bin/bash
